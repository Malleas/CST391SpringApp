package com.example.cst391springmilestone.models;
...
public class UserModel {
    ...
    @ApiModelProperty(value = "User's First Name", example = "Bob")
    ...
    @ApiModelProperty(value = "User's active email", example = "a@a.com")
    private String email;

    @NotNull(message="Phone Number is required")
    @Size(min=1, max=10, message="Phone Number must be between 1 and 10 characters")
    @ApiModelProperty(value = "User's phone number, 10 digit only", example = "1234567890")
    private String phoneNumber;

    @NotNull(message="User name is a required field")
    @Size(min=1, max=32, message="User name must be between 1 and 32 characters")
    @ApiModelProperty(value = "Username used at login time", example = "bsmith01")
    private String username;

    @NotNull(message="Password is a required field")
    @Size(min=1, max=32, message="Password must be between 1 and 32 characters")
    @ApiModelProperty(value = "Password used at login time", example = "password")
